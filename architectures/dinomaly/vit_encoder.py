...
from .dinov2.layers import Mlp, PatchEmbed, SwiGLUFFNFused, Block
...
def load():
    ...
    ckpt_pth = download_cached_file(f"https://dl.fbaipublicfiles.com/dinov2/dinov2_vitb{patch_size}/dinov2_vitb{patch_size}_reg4_pretrain.pth")
